  ...
  return (
    <div className="overflow-hidden relative z-10 sm:min-h-screen max-h-screen min-w-screen bg-gradient-to-l from-[#001B0C] via-[#001B0C] to-black poppins flex flex-col justify-center items-center">
      ...
      <AnimatePresence>
        {!isPressed && (
          <motion.div
            className="z-20 absolute content-container sm:mt-20 top-20 sm:top-20 content-container"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          >
            <motion.h1
              ...
              className="text-center font-[700] sm:text-[76px] text-[50px] uppercase text-[#9CEBDB]"
            >
              About us
            </motion.h1>
            <motion.h2
              ...
              className="z-20 text-center text-white sm:text-[24px] text-[16px] mx-10 sm:mx-20"
            >
      ...
      {isPressed && (
        <motion.div
          ...
          className="fixed bottom-5 left-1/2 transform -translate-x-1/2 sm:w-1/5 w-2/3 text-center px-4 py-2 bg-black bg-opacity-50 rounded-full text-white sm:text-lg text-sm z-30"
        >
